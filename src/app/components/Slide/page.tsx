...
function HeroSection() {
  ...
  return (
    ...
    <section className="relative  py-10 md:py-20 px-5 md:px-20 flex flex-col md:flex-row items-center justify-between overflow-hidden">
  ...
  <div className="absolute h-[22rem] inset-0 bg-cover bg-center rounded-full transform rotate-45 mt-12"style={{backgroundImage: `url('/Group 129.png')`,}}> 

    </div>
 
  <div className=" z-20 w-[10px]">
  {/* Image */}
  <img src="/Vector 14.png" alt="" className="absolute right-0 top-12 w-[70px]" />

  {/* Text Overlay */}
  <div className="absolute right-5 top-16 text-[14px]  text-white font-bold">
       50% <br />
       off
    </div>
</div>
  ...
  <div className="relative z-10 bg-gradient-to-r rounded-full p-10 mt-10">
    <img
      ...
      alt="Furniture Chair"
      className="object-contain max-w-[18rem]" // No rotation here
    />
  </div>
</div>
